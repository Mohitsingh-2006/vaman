...
\end{abstract}
	...
	\begin{figure}[H]
		...
		\caption{Curve for valid values of a and b}
		\label{fig:Hyperbola}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\columnwidth]{figs/figure_new.png} 
		\caption{Function $f(t)$ for $a = 2+\sqrt{2},b = \sqrt{2}$}
		\label{fig:Function}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\caption{Truncated Function $f(t)$ for $a = \sqrt{2}+2$ and $b = \sqrt{2}$ }
		\label{fig:Window}
	\end{figure}
...
\begin{center}
\textbf{Refrences : \\ i)Convex Optimization by Stephen Boyd and Lieven Vandenberghe\\ ii)Multiple View Geometry Second Edition}
\end{center}
	
	
\begin{figure}[H]
	\centering
	\includegraphics[width=1\columnwidth]{figs/C_theta_function.png} 
	\caption{$C(\theta)$ for $a = \sqrt{2}+2$ and $b = \sqrt{2}$}
\end{figure}	
