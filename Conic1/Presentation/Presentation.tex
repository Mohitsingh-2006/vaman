...
\begin{figure}
  \centering
  \includegraphics[width=0.5\linewidth]{figs/figure_new.png}
...
\begin{center}
\textbf{i)Convex Optimization by Stephen Boyd and Lieven Vandenberghe\\ ii)Multiple View Geometry Second Edition}
\end{center}
